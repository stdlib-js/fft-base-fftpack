...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/fft-base-fftpack@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { cffti, cosqi, costi, decompose, rffti, sinqi, sinti } from 'https://cdn.jsdelivr.net/gh/stdlib-js/fft-base-fftpack@esm/index.mjs';
```
...
[@stdlib/fft/base/fftpack/cffti]: https://github.com/stdlib-js/fft-base-fftpack-cffti/tree/esm

[@stdlib/fft/base/fftpack/cosqi]: https://github.com/stdlib-js/fft-base-fftpack-cosqi/tree/esm

[@stdlib/fft/base/fftpack/costi]: https://github.com/stdlib-js/fft-base-fftpack-costi/tree/esm

[@stdlib/fft/base/fftpack/decompose]: https://github.com/stdlib-js/fft-base-fftpack-decompose/tree/esm

[@stdlib/fft/base/fftpack/rffti]: https://github.com/stdlib-js/fft-base-fftpack-rffti/tree/esm

[@stdlib/fft/base/fftpack/sinqi]: https://github.com/stdlib-js/fft-base-fftpack-sinqi/tree/esm

[@stdlib/fft/base/fftpack/sinti]: https://github.com/stdlib-js/fft-base-fftpack-sinti/tree/esm
